...
$script:activityDiagnosticsPath = Join-Path $PSScriptRoot 'work\ActivityDotsRuntime.log'
$script:inspectorCachePath = Join-Path $PSScriptRoot 'work\CodexInspectorUrl.txt'
